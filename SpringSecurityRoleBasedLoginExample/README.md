...
1. Run the application. Open browser and go to localhost:8080/SpringSecurityRoleBasedLoginExample/

2. Now try to access admin page on localhost:8080/SpringSecurityRoleBasedLoginExample/admin, you will be prompted for login.
...
7. Now try to access db page on localhost:8080/SpringSecurityRoleBasedLoginExample/db, you will get AccessDenied page.
