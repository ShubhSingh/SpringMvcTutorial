...
[http://websystique.com/spring-security/spring-security-4-custom-login-form-annotation-example/](http://websystique.com/spring-security/spring-security-4-custom-login-form-annotation-example/)

Functionality provided in this project are as follows:


1. Run the application. Open browser and go to localhost:8080/SpringSecurityCustomLoginFormAnnotationExample/

2. Now try to access admin page on localhost:8080/SpringSecurityCustomLoginFormAnnotationExample/admin, you will be prompted for login.
...
7. Now try to access db page on localhost:8080/SpringSecurityCustomLoginFormAnnotationExample/db, you will get AccessDenied page.
